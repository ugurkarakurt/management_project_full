...
const PopperComponent = React.forwardRef<HTMLDivElement, PopperComponentProps>(
  function PopperComponent(props, ref) {
    const { disablePortal, anchorEl, open, ...other } = props;
    return <StyledAutocompletePopper {...other} ref={ref} />;
  }
);
      ...
      <StyledPopper id={id} open={open} anchorEl={anchorEl} placement="bottom-start">
        <ClickAwayListener onClickAway={handleClose}>
          <div>
            ...
            <Autocomplete<LabelType, true, false, false>
              open
              multiple
              onClose={(
